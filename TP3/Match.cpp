...
//
//template <typename E>
//Match<E> :: Match(Date d, shared_ptr<E> a, shared_ptr<E> b):date_(d), equipeA_(a), equipeB_(b),
//                                                              scoreA_(0), scoreB_(0) {}
//
//template <typename E>
//Match<E>::Match(const Match& m) : date_(m.date_), equipeA_(m.equipeA_), equipeB_(m.equipeB_),
//                                    scoreA_(m.scoreA_), scoreB_(m.scoreB_) {
//
//}
//
//template <typename E>
...
//
//template <typename E>
//void Match<E> ::setEquipeA(const shared_ptr<E>& eA) {equipeA_(eA);}
//
//
//template <typename E>
//void Match<E> ::setEquipeB(const shared_ptr<E>& eB) { equipeB_(eB); }
//
//
//template <typename E>
//void Match<E> ::setEquipes(const shared_ptr<E>& eA,
//    const shared_ptr<E>& eB) { equipeA_(eA); equipeB_(eB);}
//
//
//template <typename E>
//shared_ptr<E> Match<E> ::getEquipeA() const { return equipeA_; }
//
//
//template <typename E>
//shared_ptr<E> Match<E> ::getEquipeB() const { return equipeB_; }
//
//
//template <typename E>
//int Match<E> ::getScoreA() const { return scoreA_; }
//
//
//template <typename E>
//int Match<E> ::getScoreB() const { return scoreB_; }
//
//
//template <typename E>
